        ...
        <ul>
          {initialList[category].map(
            (product: {
              ...
              return (
                <li className="shopping-list__item" key={product.product_id}>
                  {product.completed ? (
                    <span className="shopping-list__tag">
                      {!isInEdit && (
                  ...
                  <PiecesDetail
                    ...
                    pcs={product.pieces}
                    increaseAmount={() =>
                      dispatch(increaseAmount({ id: product.product_id }))
                    }
                    decreaseAmount={() =>
                      dispatch(decreaseAmount({ id: product.product_id }))
                    }
                  />
                </li>
              );
